...
public interface MovieClient {
    ...
    @GetMapping("/api/v1/movies/{movieId}/name")
    String getMovieNameById(@PathVariable("movieId") Long movieId);

    @GetMapping(value = "/api/v1/movies/{movieId}/exists")
    boolean existsById(@PathVariable("movieId") Long movieId);
}
